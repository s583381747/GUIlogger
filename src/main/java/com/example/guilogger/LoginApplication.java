...
// Define the main class for the LoginApplication, which extends Application
public class LoginApplication extends Application {

    // Static field to hold a reference to the main stage
    public static Stage gotomain;
