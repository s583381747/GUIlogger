...
// Define the main class for the LocalStorageApplication, which extends Application
public class LocalStorageApplication extends Application {

    // The start method is called when the application is launched
    @Override
    public void start(Stage stage) throws IOException {
        // Create an FXMLLoader to load the GUI layout from an FXML file
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("LocalStorage.fxml"));
